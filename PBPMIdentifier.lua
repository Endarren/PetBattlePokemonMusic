-- Author      : Endar_Ren
-- Create Date : 6/30/2015 9:10:26 AM


local L						= LibStub("AceLocale-3.0"):GetLocale("PetBattlePokemonMusic")
local tamerIDstoNames = {}

tamerIDstoNames[85519] = "Christoph VonFeasel"
tamerIDstoNames[67370] = L["Jeremy Feasel"]
tamerIDstoNames[73626] = L["Little Tommy Newcomer"]

--Eastern Kingdoms
tamerIDstoNames[64330] = L["Julia Stevens"]
tamerIDstoNames[65648] = L["Old MacDonald"]
tamerIDstoNames[65651] = L["Lindsay"]
tamerIDstoNames[65655] = L["Eric Davidson"]
tamerIDstoNames[63194] = L["Steven Lisbane"]
tamerIDstoNames[65656] = L["Bill Buckler"]
tamerIDstoNames[66478] = L["David Kosse"]
tamerIDstoNames[66512] = L["Deiza Plaguehorn"]
tamerIDstoNames[66520] = L["Durin Darkhammer"]
tamerIDstoNames[66518] = L["Everessa"]
tamerIDstoNames[66522] = L["Lydia Accoste"]
tamerIDstoNames[66515] = L["Kortas Darkhammer"]
-- Kalimdor

tamerIDstoNames[66466] = L["Stone Cold Trixxy"]
tamerIDstoNames[66136] = L["Analynn"]
tamerIDstoNames[66422] = L["Cassandra Kaboom"]
tamerIDstoNames[66135] = L["Dagra the Fierce"]
tamerIDstoNames[66412] = L["Elena Flutterfly"]
tamerIDstoNames[66436] = L["Grazzle the Great"]
tamerIDstoNames[66452] = L["Kela Grimtotem"]
tamerIDstoNames[66372] = L["Merda Stronghoof"]
tamerIDstoNames[66352] = L["Traitor Gluk"]
tamerIDstoNames[66442] = L["Zoltan"]
tamerIDstoNames[66137] = L["Zonya the Sadist"]
tamerIDstoNames[66126] = L["Zunta"]

-- Outland
tamerIDstoNames[66557] = L["Bloodknight Antari"]
tamerIDstoNames[66552] = L["Narrok"]
tamerIDstoNames[66550] = L["Nicki Tinytech"]
tamerIDstoNames[66553] = L["Morulu The Elder"]
tamerIDstoNames[66551] = L["Ras'an"]

-- Northrend
tamerIDstoNames[66675] = L["Major Payne"]
tamerIDstoNames[66635] = L["Beegle Blastfuse"]
tamerIDstoNames[66639] = L["Gutretch"]
tamerIDstoNames[66636] = L["Nearly Headless Jacob"]
tamerIDstoNames[66638] = L["Okrut Dragonwaste"]


-- Cataclysm
tamerIDstoNames[66815] = L["Bordin Steadyfist"]
tamerIDstoNames[66819] = L["Brok"]
tamerIDstoNames[66822] = L["Goz Banefury"]
tamerIDstoNames[66824] = L["Obalis"]

-- Pandaria
tamerIDstoNames[66741] = L["Aki the Chosen"]
tamerIDstoNames[66738] = L["Courageous Yon"]
tamerIDstoNames[66734] = L["Farmer Nishi"]
tamerIDstoNames[66730] = L["Hyuna of the Shrines"]
tamerIDstoNames[66733] = L["Mo'ruk"]
tamerIDstoNames[66918] = L["Seeker Zusshi"]
tamerIDstoNames[66739] = L["Wastewalker Shu"]

-- Pandaria Elemental Spirits

tamerIDstoNames[68463] = L["Burning Pandaren Spirit"]
tamerIDstoNames[68462] = L["Flowing Pandaren Spirit"]
tamerIDstoNames[68465] = L["Thundering Pandaren Spirit"]
tamerIDstoNames[68464] = L["Whispering Pandaren Spirit"]


-- Celestial Tournament
tamerIDstoNames[71926] = L["Lorewalker Cho"]
tamerIDstoNames[71934] = L["Dr. Ion Goldbloom"]
tamerIDstoNames[71929] = L["Sully \"The Pickle\" McLeary"]

tamerIDstoNames[71931] = L["Taran Zhu"]
tamerIDstoNames[71927] = L["Chen Stormstout"]
tamerIDstoNames[71924] = L["Wrathion"]

tamerIDstoNames[71932] = L["Wise Mari"]
tamerIDstoNames[71933] = L["Blingtron 4000"]
tamerIDstoNames[71930] = L["Shademaster Kiryn"]

tamerIDstoNames[72285] = "Chi-Chi, Hatchling of Chi-Ji"
tamerIDstoNames[72009] = "Xu-Fu, Cub of Xuen"
tamerIDstoNames[72291] = "Yu'la, Broodling of Yu'lon"
tamerIDstoNames[72290] = "Zao, calfling of Niuzao"

-- Draenor

tamerIDstoNames[87124] = L["Ashlei"]
tamerIDstoNames[83837] = L["Cymre Brightblade"]
tamerIDstoNames[87122] = L["Gargra"]
tamerIDstoNames[87125] = L["Taralune"]
tamerIDstoNames[87110] = L["Tarr the Terrible"]
tamerIDstoNames[87123] = L["Vesharr"]

-- Garrison

tamerIDstoNames[90675] = L["Erris (Spores, Dusty, and Salad)"]
tamerIDstoNames[91014] = L["Erris (Moon, Mouthy, and Carl)"]
tamerIDstoNames[91015] = L["Erris (Enbi'see, Mal, and Bones)"]
tamerIDstoNames[91016] = L["Erris (Sprouts, Prince Charming, and Runts)"]
tamerIDstoNames[91017] = L["Erris (Nicodemus, Brisby, and Jenner)"]

tamerIDstoNames[91026] = L["Kura Thunderhoof (Spores, Dusty, and Salad)"]
tamerIDstoNames[91361] = L["Kura Thunderhoof (Moon, Mouthy, and Carl)"]
tamerIDstoNames[91362] = L["Kura Thunderhoof (Enbi'see, Mal, and Bones)"]
tamerIDstoNames[91363] = L["Kura Thunderhoof (Sprouts, Prince Charming, and Runts)"]
tamerIDstoNames[91364] = L["Kura Thunderhoof (Nicodemus, Brisby, and Jenner)"]

-- Menageria

tamerIDstoNames[79751] = L["Eleanor"]
tamerIDstoNames[85629] = L["Challenge Post (Tirs, Fiero)"]
tamerIDstoNames[85630] = L["Challenge Post (Rockbiter, Stonechewer, Acidtooth)"]
tamerIDstoNames[85650] = L["Quintessence of Light"]
tamerIDstoNames[85632] = L["Challenge Post (Blingtron 4999b, Protectron 022481, Protectron 011803)"]
tamerIDstoNames[85685] = L["Stitches Jr."]

tamerIDstoNames[85634] = L["Challenge Post (Manos, Hanos, Fatos)"]
tamerIDstoNames[79179] = L["Squirt (Deebs, Tyri, Puzzle)"]
tamerIDstoNames[85622] = L["Challenge Post (Brutus, Rukus)"]
tamerIDstoNames[85517] = L["Challenge Post (Mr. Terrible, Carroteye, Sloppus)"]
tamerIDstoNames[85659] = L["The Beakinator"]
tamerIDstoNames[85624] = L["Challenge Post (Queen Floret, King Floret)"]
tamerIDstoNames[85625] = L["Challenge Post (Kromli, Gromli)"]
tamerIDstoNames[85626] = L["Challenge Post (Grubbles, Scrags, Stings)"]
tamerIDstoNames[85627] = L["Challenge Post (Jahan, Samm, Archimedes)"]
...
pveDB.Tamers["Ashlei"] = {Pets = {}}
pveDB.Tamers["Ashlei"].Pets["Doodle"] = {	Name = "Doodle",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 6}
pveDB.Tamers["Ashlei"].Pets["Pixiebell"] = {	Name = "Pixiebell",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 6}
pveDB.Tamers["Ashlei"].Pets["Tally"] = {	Name = "Tally",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}

pveDB.Tamers["Cymre Brightblade"] = {Pets = {}}
pveDB.Tamers["Cymre Brightblade"].Pets["Gyrexle, the Eternal Mechanic"] = {	Name = "Gyrexle, the Eternal Mechanic",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 10}
pveDB.Tamers["Cymre Brightblade"].Pets["Idol of Decay"] = {	Name = "Idol of Decay",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 4}
pveDB.Tamers["Cymre Brightblade"].Pets["Wishbright Lantern"] = {	Name = "Wishbright Lantern",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 6}
...
pveDB.Tamers["Gargra"] = {Pets = {}}

pveDB.Tamers["Gargra"].Pets["Fangra"] = {	Name = "Fangra",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}
pveDB.Tamers["Gargra"].Pets["Wolfgar"] = {	Name = "Wolfgar",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}
pveDB.Tamers["Gargra"].Pets["Wolfus"] = {	Name = "Wolfus",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}

pveDB.Tamers["Taralune"] = {Pets = {}}
pveDB.Tamers["Taralune"].Pets["Atonement"] = {	Name = "Atonement",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Taralune"].Pets["Grace"] = {	Name = "Grace",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Taralune"].Pets["Serendipity"] = {	Name = "Serendipity",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
...
pveDB.Tamers["Tarr the Terrible"] = {Pets = {}}
pveDB.Tamers["Tarr the Terrible"].Pets["Gladiator Deathy"] = {	Name = "Gladiator Deathy",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 1}
pveDB.Tamers["Tarr the Terrible"].Pets["Gladiator Deathy"] = {	Name = "Gladiator Deathy",
											...
											Breed = 3,
											Type = 1}
pveDB.Tamers["Tarr the Terrible"].Pets["Gladiator Murkimus"] = {	Name = "Gladiator Murkimus",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 1}
...
pveDB.Tamers["Vesharr"] = {Pets = {}}
pveDB.Tamers["Vesharr"].Pets["Apexis Guardian"] = {	Name = "Apexis Guardian",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 10}
pveDB.Tamers["Vesharr"].Pets["The Great Kaliri"] = {	Name = "The Great Kaliri",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Vesharr"].Pets["Gladiator Murkimus"] = {	Name = "Gladiator Murkimus",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 1}
...
pveDB.Tamers["Erris (Spores, Dusty, and Salad)"] = {Pets = {}}
pveDB.Tamers["Erris (Spores, Dusty, and Salad)"].Pets["Spores"] = {	Name = "Spores",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Erris (Spores, Dusty, and Salad)"].Pets["Dusty"] = {	Name = "Dusty",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Erris (Spores, Dusty, and Salad)"].Pets["Salad"] = {	Name = "Salad",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 7}
...
pveDB.Tamers["Erris (Moon, Mouthy, and Carl)"] = {Pets = {}}
pveDB.Tamers["Erris (Moon, Mouthy, and Carl)"].Pets["Mouthy"] = {	Name = "Mouthy",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 9}
pveDB.Tamers["Erris (Moon, Mouthy, and Carl)"].Pets["Carl"] = {	Name = "Carl",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}
pveDB.Tamers["Erris (Moon, Mouthy, and Carl)"].Pets["Moon"] = {	Name = "Moon",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 9}
...
pveDB.Tamers["Erris (Enbi'see, Mal, and Bones)"] = {Pets = {}}
pveDB.Tamers["Erris (Enbi'see, Mal, and Bones)"].Pets["Enbi'see"]={Name = "Enbi'see",Level = 23, Quality= 4,Type= 3}
pveDB.Tamers["Erris (Enbi'see, Mal, and Bones)"].Pets["Mal"]={Name = "Mal",Level = 23, Quality= 3,Type= 3}
pveDB.Tamers["Erris (Enbi'see, Mal, and Bones)"].Pets["Bones"]={Name = "Bones",Level = 23, Quality= 4,Type= 4}


pveDB.Tamers["Erris (Sprouts, Prince Charming, and Runts)"] = {Pets = {}}
pveDB.Tamers["Erris (Sprouts, Prince Charming, and Runts)"].Pets["Sprouts"]={Name = "Sprouts",Level = 23, Quality= 4,Type= 7}
pveDB.Tamers["Erris (Sprouts, Prince Charming, and Runts)"].Pets["Prince Charming"]={Name = "Prince Charming",Level = 23, Quality= 3,Type= 9}
pveDB.Tamers["Erris (Sprouts, Prince Charming, and Runts)"].Pets["Runts"]={Name = "Runts",Level = 23, Quality= 4,Type= 8}
pveDB.Tamers["Erris (Nicodemus, Brisby, and Jenner)"] = {Pets = {}}


pveDB.Tamers["Erris (Nicodemus, Brisby, and Jenner)"].Pets["Nicodemus"] = {	Name = "Nicodemus",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 5}
pveDB.Tamers["Erris (Nicodemus, Brisby, and Jenner)"].Pets["Brisby"] = {	Name = "Brisby",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 5}
pveDB.Tamers["Erris (Nicodemus, Brisby, and Jenner)"].Pets["Jenner"] = {	Name = "Jenner",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 7}

pveDB.Tamers["Kura Thunderhoof (Spores, Dusty, and Salad)"] = {Pets = {}}
pveDB.Tamers["Kura Thunderhoof (Spores, Dusty, and Salad)"].Pets["Spores"] = {	Name = "Spores",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Kura Thunderhoof (Spores, Dusty, and Salad)"].Pets["Dusty"] = {	Name = "Dusty",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
pveDB.Tamers["Kura Thunderhoof (Spores, Dusty, and Salad)"].Pets["Salad"] = {	Name = "Salad",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 7}
											
pveDB.Tamers["Kura Thunderhoof (Moon, Mouthy, and Carl)"] = {Pets = {}}
pveDB.Tamers["Kura Thunderhoof (Moon, Mouthy, and Carl)"].Pets["Mouthy"] = {	Name = "Mouthy",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 9}
pveDB.Tamers["Kura Thunderhoof (Moon, Mouthy, and Carl)"].Pets["Carl"] = {	Name = "Carl",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 8}
pveDB.Tamers["Kura Thunderhoof (Moon, Mouthy, and Carl)"].Pets["Moon"] = {	Name = "Moon",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 9}
...
pveDB.Tamers["Kura Thunderhoof (Enbi'see, Mal, and Bones)"] = {Pets = {}}
pveDB.Tamers["Kura Thunderhoof (Enbi'see, Mal, and Bones)"].Pets["Enbi'see"]={Name = "Enbi'see",Level = 23, Quality= 4,Type= 3}
pveDB.Tamers["Kura Thunderhoof (Enbi'see, Mal, and Bones)"].Pets["Mal"]={Name = "Mal",Level = 23, Quality= 3,Type= 3}
pveDB.Tamers["Kura Thunderhoof (Enbi'see, Mal, and Bones)"].Pets["Bones"]={Name = "Bones",Level = 23, Quality= 4,Type= 4}

pveDB.Tamers["Kura Thunderhoof (Sprouts, Prince Charming, and Runts)"] = {Pets = {}}
pveDB.Tamers["Kura Thunderhoof (Sprouts, Prince Charming, and Runts)"].Pets["Sprouts"]={Name = "Sprouts",Level = 23, Quality= 4,Type= 7}
pveDB.Tamers["Kura Thunderhoof (Sprouts, Prince Charming, and Runts)"].Pets["Prince Charming"]={Name = "Prince Charming",Level = 23, Quality= 3,Type= 9}
pveDB.Tamers["Kura Thunderhoof (Sprouts, Prince Charming, and Runts)"].Pets["Runts"]={Name = "Runts",Level = 23, Quality= 4,Type= 8}

pveDB.Tamers["Kura Thunderhoof (Nicodemus, Brisby, and Jenner)"] = {Pets = {}}
pveDB.Tamers["Kura Thunderhoof (Nicodemus, Brisby, and Jenner)"].Pets["Nicodemus"] = {	Name = "Nicodemus",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 5}
pveDB.Tamers["Kura Thunderhoof (Nicodemus, Brisby, and Jenner)"].Pets["Brisby"] = {	Name = "Brisby",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 5}
pveDB.Tamers["Kura Thunderhoof (Nicodemus, Brisby, and Jenner)"].Pets["Jenner"] = {	Name = "Jenner",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 7}
...
-- Menageria
pveDB.Tamers["Squirt (Deebs, Tyri, Puzzle)"] = {Pets = {}}
pveDB.Tamers["Squirt (Deebs, Tyri, Puzzle)"].Pets["Deebs"] = {	Name = "Deebs",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 6}
pveDB.Tamers["Squirt (Deebs, Tyri, Puzzle)"].Pets["Tyri"] = {	Name = "Tyri",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 1}
pveDB.Tamers["Squirt (Deebs, Tyri, Puzzle)"].Pets["Puzzle"] = {	Name = "Puzzle",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 1}
											
pveDB.Tamers["Eleanor"] = {Pets = {}}
pveDB.Tamers["Eleanor"].Pets["Eleanor"]= {	Name = "Eleanor",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 4}
											
pveDB.Tamers["Stitches Jr."] = {Pets = {}}
pveDB.Tamers["Stitches Jr."].Pets["Stitches Jr."]= {	Name = "Stitches Jr.",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 4}
pveDB.Tamers["The Beakinator"] = {Pets = {}}		
pveDB.Tamers["The Beakinator"].Pets["The Beakinator"]= {	Name = "The Beakinator",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
...
pveDB.Tamers["Quintessence of Light"] = {Pets = {}}
pveDB.Tamers["Quintessence of Light"].Pets["Quintessence of Light"]= {	Name = "Quintessence of Light",
											Level = 25,
											Quality = 4,
											Breed = 3,
											Type = 3}
...
pveDB.Tamers["Challenge Post (Tirs, Fiero)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Tirs, Fiero)"].Pets["Tirs"]={Name = "Tirs",Level = 25, Quality= 4,Type= 7}
pveDB.Tamers["Challenge Post (Tirs, Fiero)"].Pets["Fiero"]={Name = "Fiero",Level = 25, Quality= 4,Type= 7}

pveDB.Tamers["Challenge Post (Rockbiter, Stonechewer, Acidtooth)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Rockbiter, Stonechewer, Acidtooth)"].Pets["Rockbiter"]={Name = "Rockbiter",Level = 25, Quality= 4,Type= 1}
pveDB.Tamers["Challenge Post (Rockbiter, Stonechewer, Acidtooth)"].Pets["Stonechewer"]={Name = "Stonechewer",Level = 25, Quality= 4,Type= 1}
pveDB.Tamers["Challenge Post (Rockbiter, Stonechewer, Acidtooth)"].Pets["Acidtooth"]={Name = "Acidtooth",Level = 25, Quality= 4,Type= 1}



pveDB.Tamers["Challenge Post (Blingtron 4999b, Protectron 022481, Protectron 011803)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Blingtron 4999b, Protectron 022481, Protectron 011803)"].Pets["Blingtron 4999b"]={Name = "Blingtron 4999b",Level = 25, Quality= 4,Type= 10}
pveDB.Tamers["Challenge Post (Blingtron 4999b, Protectron 022481, Protectron 011803)"].Pets[" Protectron 022481"]={Name = " Protectron 022481",Level = 25, Quality= 4,Type= 10}
pveDB.Tamers["Challenge Post (Blingtron 4999b, Protectron 022481, Protectron 011803)"].Pets["Protectron 011803"]={Name = "Protectron 011803",Level = 25, Quality= 4,Type= 10}




pveDB.Tamers["Challenge Post (Manos, Hanos, Fatos)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Manos, Hanos, Fatos)"].Pets["Manos"]={Name = "Manos",Level = 25, Quality= 4,Type= 6}
pveDB.Tamers["Challenge Post (Manos, Hanos, Fatos)"].Pets["Hanos"]={Name = "Hanos",Level = 25, Quality= 4,Type= 6}
pveDB.Tamers["Challenge Post (Manos, Hanos, Fatos)"].Pets["Fatos"]={Name = "Fatos",Level = 25, Quality= 4,Type= 6}
pveDB.Tamers["Challenge Post (Brutus, Rukus)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Brutus, Rukus)"].Pets["Brutus"]={Name = "Brutus",Level = 25, Quality= 4,Type= 8}
pveDB.Tamers["Challenge Post (Brutus, Rukus)"].Pets["Rukus"]={Name = "Rukus",Level = 25, Quality= 4,Type= 8}
pveDB.Tamers["Challenge Post (Mr. Terrible, Carroteye, Sloppus)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Mr. Terrible, Carroteye, Sloppus)"].Pets["Mr. Terrible"]={Name = "Mr. Terrible",Level = 25, Quality= 4,Type= 7}
pveDB.Tamers["Challenge Post (Mr. Terrible, Carroteye, Sloppus)"].Pets["Carroteye"]={Name = "Carroteye",Level = 25, Quality= 4,Type= 7}
pveDB.Tamers["Challenge Post (Mr. Terrible, Carroteye, Sloppus)"].Pets["Sloppus"]={Name = "Sloppus",Level = 25, Quality= 4,Type= 6}
pveDB.Tamers["Challenge Post (Queen Floret, King Floret)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Queen Floret, King Floret)"].Pets["Queen Floret"]={Name = "Queen Floret",Level = 25, Quality= 4,Type= 7}
pveDB.Tamers["Challenge Post (Queen Floret, King Floret)"].Pets["King Floret"]={Name = "King Floret",Level = 25, Quality= 4,Type= 7}
pveDB.Tamers["Challenge Post (Kromli, Gromli)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Kromli, Gromli)"].Pets["Kromli"]={Name = "Kromli",Level = 25, Quality= 4,Type= 1}
pveDB.Tamers["Challenge Post (Kromli, Gromli)"].Pets["Gromli"]={Name = "Gromli",Level = 25, Quality= 4,Type= 1}
pveDB.Tamers["Challenge Post (Grubbles, Scrags, Stings)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Grubbles, Scrags, Stings)"].Pets["Grubbles"]={Name = "Grubbles",Level = 25, Quality= 4,Type= 5}
pveDB.Tamers["Challenge Post (Grubbles, Scrags, Stings)"].Pets["Scrags"]={Name = "Scrags",Level = 25, Quality= 4,Type= 8}
pveDB.Tamers["Challenge Post (Grubbles, Scrags, Stings)"].Pets["Stings"]={Name = "Stings",Level = 25, Quality= 4,Type= 3}
pveDB.Tamers["Challenge Post (Jahan, Samm, Archimedes)"] = {Pets = {}}
pveDB.Tamers["Challenge Post (Jahan, Samm, Archimedes)"].Pets["Jahan"]={Name = "Jahan",Level = 25, Quality= 4,Type= 3}
pveDB.Tamers["Challenge Post (Jahan, Samm, Archimedes)"].Pets["Samm"]={Name = "Samm",Level = 25, Quality= 4,Type= 3}
pveDB.Tamers["Challenge Post (Jahan, Samm, Archimedes)"].Pets["Archimedes"]={Name = "Archimedes",Level = 25, Quality= 4,Type= 3}
...
local duelistName = ""
function PetBattlePokemonMusic:ClearDuelistName()
	duelistName = ""
end
...
function PetBattlePokemonMusic:GetpveDB()
	return pveDB
end
function PetBattlePokemonMusic:CreateTamerIdentifierData()

	for i = 1, C_PetBattles.GetNumPets(2) do
		print("[\""..C_PetBattles.GetName(2,i).."\"]={Name = \""..C_PetBattles.GetName(2,i)..
												"\",Level = "..C_PetBattles.GetLevel(2,i)..
													", Quality= "..C_PetBattles.GetBreedQuality(2,i)..
														",Type= "..C_PetBattles.GetPetType (2,i)..
														"}"
			)
	end
end
function PetBattlePokemonMusic:GetTamerName ()
--TODO check if new identifier works
--[[	local unit = UnitGUID('npc')
	local id = unit and tonumber(select(6, strsplit('-', unit)), nil)
	
	local nam = PetBattlePokemonMusic:MatchTamerIDwithName (id)
	if  nam == nil then
			return L["UNKNOWN"]
	else
	return nam
	...
	local	matches = PetBattlePokemonMusic:TableSize(pveDB.Tamers[key].Pets)
		...
		if matches == 0 and PetBattlePokemonMusic:TableSize(pveDB.Tamers[key].Pets) ~= 0 then
			return key
		end
	end
...
function PetBattlePokemonMusic:MatchTamerIDwithName (tamerID)
	
	if tamerIDstoNames[tamerID] ~= nil then
		print(tamerIDstoNames[tamerID] )
		return tamerIDstoNames[tamerID];
	else
		return nil;
	end
end
function PetBattlePokemonMusic:DetermineBattleType ()
	...
	--print("This is a ".. battleType.." against ".. opponentName)
...
function PetBattlePokemonMusic:IdentifyBattleType()
	...
	--Check if the battle is against a wild pet.
	if C_PetBattles.IsWildBattle() == true then
		--Return type and lead pet if so
		return L["WILD"], C_PetBattles.GetName(2,1)
	end
	--Check if the battle is not against a human player.
	if C_PetBattles.IsPlayerNPC(2) == true then
		--If opponent is NPC, return type as tamer and opponent name as UNKNOWN.
		return L["TAMER"], L["UNKNOWN"]
	else
		--Return type as PvP and use player detection info.
		return "PvP", duelistName
	end
end